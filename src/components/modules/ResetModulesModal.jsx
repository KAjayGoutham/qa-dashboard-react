...
export const ResetModulesModal = ({ isOpen, onClose, onConfirm, currentEnvironment }) => {
            ...
            return (
                <>
                    <div className="alert alert-warning d-flex align-items-start mb-3">
                        ...
                        <div>
                            <strong>Warning!</strong> This action will reset ALL modules in the <strong>{currentEnvironment}</strong> environment to <strong>In Progress</strong> status.
                        </div>
                    </div>
            ...
            return (
                <>
                    <div className="alert alert-success d-flex align-items-start mb-3">
                        ...
                        <div>
                            <strong>Confirmation Required!</strong> This action will mark ALL modules in the <strong>{currentEnvironment}</strong> environment as <strong>Passed</strong>.
                        </div>
                    </div>
                    <p className="mb-2">This will:</p>
                    <ul className="mb-3">
